...
// ==============================================================
#ifndef __honeybee_sitofp_3fYi__HH__
#define __honeybee_sitofp_3fYi__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(honeybee_sitofp_3fYi) {
    ...
    SC_CTOR(honeybee_sitofp_3fYi):  ACMP_sitofp_U ("ACMP_sitofp_U") {
