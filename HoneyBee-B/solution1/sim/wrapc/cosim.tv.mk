...
IFLAG += -D__SIM_DDS__
IFLAG += -D__DSP48E1__
IFLAG += -Wno-unknown-pragmas -Wno-constant-conversion
...
$(ObjDir)/honeybee_test.c_pre.c.tb.o : honeybee_test.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) honeybee_test.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/honeybee.c_pre.c.tb.o : honeybee.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) honeybee.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
