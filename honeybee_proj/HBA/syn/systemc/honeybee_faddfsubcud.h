...
// ==============================================================
#ifndef __honeybee_faddfsubcud__HH__
#define __honeybee_faddfsubcud__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(honeybee_faddfsubcud) {
    ...
    SC_CTOR(honeybee_faddfsubcud):  ACMP_faddfsub_U ("ACMP_faddfsub_U") {
