...
// ==============================================================
#ifndef __honeybee_sitofp_3hbi__HH__
#define __honeybee_sitofp_3hbi__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(honeybee_sitofp_3hbi) {
    ...
    SC_CTOR(honeybee_sitofp_3hbi):  ACMP_sitofp_U ("ACMP_sitofp_U") {
