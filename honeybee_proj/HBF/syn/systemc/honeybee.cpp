...
honeybee::honeybee(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    grp_checkAxis_2_fu_64->ap_start(grp_checkAxis_2_fu_64_ap_start);
    grp_checkAxis_2_fu_64->ap_done(grp_checkAxis_2_fu_64_ap_done);
    grp_checkAxis_2_fu_64->ap_idle(grp_checkAxis_2_fu_64_ap_idle);
    grp_checkAxis_2_fu_64->ap_ready(grp_checkAxis_2_fu_64_ap_ready);
    ...
    grp_checkAxis_1_fu_80->ap_start(grp_checkAxis_1_fu_80_ap_start);
    grp_checkAxis_1_fu_80->ap_done(grp_checkAxis_1_fu_80_ap_done);
    grp_checkAxis_1_fu_80->ap_idle(grp_checkAxis_1_fu_80_ap_idle);
    grp_checkAxis_1_fu_80->ap_ready(grp_checkAxis_1_fu_80_ap_ready);
    ...
    sensitive << ( grp_checkAxis_2_fu_64_ap_done );
    sensitive << ( grp_checkAxis_1_fu_80_ap_done );
    ...
    sensitive << ( ap_CS_fsm_state2 );
    sensitive << ( or_ln164_fu_112_p2 );
    sensitive << ( ap_block_state2_on_subcall_done );

    SC_METHOD(thread_grp_checkAxis_0_fu_96_ap_start);
    sensitive << ( grp_checkAxis_0_fu_96_ap_start_reg );

    SC_METHOD(thread_grp_checkAxis_1_fu_80_ap_start);
    sensitive << ( grp_checkAxis_1_fu_80_ap_start_reg );

    SC_METHOD(thread_grp_checkAxis_2_fu_64_ap_start);
    sensitive << ( grp_checkAxis_2_fu_64_ap_start_reg );

    SC_METHOD(thread_or_ln164_fu_112_p2);
    sensitive << ( grp_checkAxis_2_fu_64_ap_return );
    ...
    ap_CS_fsm = "01";
    grp_checkAxis_2_fu_64_ap_start_reg = SC_LOGIC_0;
    grp_checkAxis_1_fu_80_ap_start_reg = SC_LOGIC_0;
    ...
    sc_trace(mVcdFile, grp_checkAxis_2_fu_64_ap_start, "grp_checkAxis_2_fu_64_ap_start");
    sc_trace(mVcdFile, grp_checkAxis_2_fu_64_ap_done, "grp_checkAxis_2_fu_64_ap_done");
    sc_trace(mVcdFile, grp_checkAxis_2_fu_64_ap_idle, "grp_checkAxis_2_fu_64_ap_idle");
    sc_trace(mVcdFile, grp_checkAxis_2_fu_64_ap_ready, "grp_checkAxis_2_fu_64_ap_ready");
    sc_trace(mVcdFile, grp_checkAxis_2_fu_64_ap_return, "grp_checkAxis_2_fu_64_ap_return");
    sc_trace(mVcdFile, grp_checkAxis_1_fu_80_ap_start, "grp_checkAxis_1_fu_80_ap_start");
    sc_trace(mVcdFile, grp_checkAxis_1_fu_80_ap_done, "grp_checkAxis_1_fu_80_ap_done");
    sc_trace(mVcdFile, grp_checkAxis_1_fu_80_ap_idle, "grp_checkAxis_1_fu_80_ap_idle");
    sc_trace(mVcdFile, grp_checkAxis_1_fu_80_ap_ready, "grp_checkAxis_1_fu_80_ap_ready");
    ...
    sc_trace(mVcdFile, grp_checkAxis_2_fu_64_ap_start_reg, "grp_checkAxis_2_fu_64_ap_start_reg");
    sc_trace(mVcdFile, ap_CS_fsm_state2, "ap_CS_fsm_state2");
    sc_trace(mVcdFile, grp_checkAxis_1_fu_80_ap_start_reg, "grp_checkAxis_1_fu_80_ap_start_reg");
    sc_trace(mVcdFile, grp_checkAxis_0_fu_96_ap_start_reg, "grp_checkAxis_0_fu_96_ap_start_reg");
    sc_trace(mVcdFile, or_ln164_fu_112_p2, "or_ln164_fu_112_p2");
...
void honeybee::thread_ap_clk_no_reset_() {
    ...
    if ( ap_rst.read() == ap_const_logic_1) {
        ...
        } else if (esl_seteq<1,1,1>(ap_const_logic_1, grp_checkAxis_1_fu_80_ap_ready.read())) {
            grp_checkAxis_1_fu_80_ap_start_reg = ap_const_logic_0;
        }
    }
    if ( ap_rst.read() == ap_const_logic_1) {
        ...
        } else if (esl_seteq<1,1,1>(ap_const_logic_1, grp_checkAxis_2_fu_64_ap_ready.read())) {
            grp_checkAxis_2_fu_64_ap_start_reg = ap_const_logic_0;
        }
    }
}
...
void honeybee::thread_ap_block_state2_on_subcall_done() {
    ap_block_state2_on_subcall_done = (esl_seteq<1,1,1>(ap_const_logic_0, grp_checkAxis_2_fu_64_ap_done.read()) || esl_seteq<1,1,1>(ap_const_logic_0, grp_checkAxis_0_fu_96_ap_done.read()) || esl_seteq<1,1,1>(ap_const_logic_0, grp_checkAxis_1_fu_80_ap_done.read()));
}
...
void honeybee::thread_ap_return() {
    ap_return = (or_ln164_fu_112_p2.read() | grp_checkAxis_0_fu_96_ap_return.read());
}
...
void honeybee::thread_grp_checkAxis_1_fu_80_ap_start() {
    grp_checkAxis_1_fu_80_ap_start = grp_checkAxis_1_fu_80_ap_start_reg.read();
}

void honeybee::thread_grp_checkAxis_2_fu_64_ap_start() {
    grp_checkAxis_2_fu_64_ap_start = grp_checkAxis_2_fu_64_ap_start_reg.read();
}

void honeybee::thread_or_ln164_fu_112_p2() {
    or_ln164_fu_112_p2 = (grp_checkAxis_2_fu_64_ap_return.read() | grp_checkAxis_1_fu_80_ap_return.read());
}
