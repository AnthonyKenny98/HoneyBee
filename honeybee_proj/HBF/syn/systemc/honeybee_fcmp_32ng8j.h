...
// ==============================================================
#ifndef __honeybee_fcmp_32ng8j__HH__
#define __honeybee_fcmp_32ng8j__HH__
#include "ACMP_fcmp.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(honeybee_fcmp_32ng8j) {
    ...
    SC_CTOR(honeybee_fcmp_32ng8j):  ACMP_fcmp_U ("ACMP_fcmp_U") {
        ACMP_fcmp_U.clk(clk);
