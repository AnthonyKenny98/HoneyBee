...
p_hls_fptosi_float_i::p_hls_fptosi_float_i(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    SC_METHOD(thread_tmp_17_fu_156_p4);
    ...
    sc_trace(mVcdFile, tmp_17_fu_156_p4, "tmp_17_fu_156_p4");
...
void p_hls_fptosi_float_i::thread_ap_return() {
    ap_return = (!p_Result_s_fu_48_p3.read()[0].is_01())? sc_lv<32>(): ((p_Result_s_fu_48_p3.read()[0].to_bool())? result_V_1_fu_174_p2.read(): p_Val2_5_fu_166_p3.read());
}
...
void p_hls_fptosi_float_i::thread_p_Val2_5_fu_166_p3() {
    p_Val2_5_fu_166_p3 = (!isNeg_fu_94_p3.read()[0].is_01())? sc_lv<32>(): ((isNeg_fu_94_p3.read()[0].to_bool())? zext_ln662_fu_152_p1.read(): tmp_17_fu_156_p4.read());
}
...
void p_hls_fptosi_float_i::thread_result_V_1_fu_174_p2() {
    result_V_1_fu_174_p2 = (!ap_const_lv32_0.is_01() || !p_Val2_5_fu_166_p3.read().is_01())? sc_lv<32>(): (sc_biguint<32>(ap_const_lv32_0) - sc_biguint<32>(p_Val2_5_fu_166_p3.read()));
}
...
void p_hls_fptosi_float_i::thread_tmp_17_fu_156_p4() {
    tmp_17_fu_156_p4 = r_V_1_fu_138_p2.read().range(55, 24);
}
