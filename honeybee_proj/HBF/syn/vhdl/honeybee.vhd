...
architecture behav of honeybee is 
    ...
    "honeybee,hls_ip_2019_2,{HLS_INPUT_TYPE=c,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z030i-fbg484-2L,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=9.478400,HLS_SYN_LAT=214,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=51,HLS_SYN_FF=13667,HLS_SYN_LUT=30475,HLS_VERSION=2019_2}";
    ...
    signal or_ln164_fu_112_p2 : STD_LOGIC_VECTOR (63 downto 0);
...
begin
    ...
    ap_return <= (or_ln164_fu_112_p2 or grp_checkAxis_0_fu_96_ap_return);
    ...
    or_ln164_fu_112_p2 <= (grp_checkAxis_2_fu_64_ap_return or grp_checkAxis_1_fu_80_ap_return);
end behav;
