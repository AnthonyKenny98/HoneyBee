...
// ==============================================================
#ifndef __honeybee_faddfsubbkb__HH__
#define __honeybee_faddfsubbkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(honeybee_faddfsubbkb) {
    ...
    SC_CTOR(honeybee_faddfsubbkb):  ACMP_faddfsub_U ("ACMP_faddfsub_U") {
