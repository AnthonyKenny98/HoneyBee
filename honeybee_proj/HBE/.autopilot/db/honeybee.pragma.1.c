...
# 83 "src/honeybee.c"
    ...
    checkAxis_loop:for (int i=0; i<4; i++) {
_ssdm_Unroll(0,0,0, "");
# 102 "src/honeybee.c"
        ...
        if (num==0) {
            ...
            if (pointOnSegment(POI, _edge)) {
                collisions = (collisions | (or << shiftAmount((int) POI.x, i, (int) POI.z)));
                collisions = (collisions | (or << shiftAmount((int) POI.x, i-1, (int) POI.z)));
            }
        }
            ...
            if (pointOnSegment(POI, _edge)) {
                collisions = (collisions | (or << shiftAmount(i, (int) POI.y, (int) POI.z)));
                collisions = (collisions | (or << shiftAmount(i - 1, (int) POI.y, (int) POI.z)));
            }
        }
    }
