...
if {[file isfile honeybee.autotvin.dat]} {
	file delete -force honeybee.autotvin.dat
}

if {[file isfile honeybee.autotvout.dat]} {
	file delete -force honeybee.autotvout.dat
}
