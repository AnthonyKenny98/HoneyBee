...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.honeybee.autotvin_obs_x.dat"
         "c.honeybee.autotvin_obs_y.dat"
         "c.honeybee.autotvin_obs_z.dat"
         "c.honeybee.autotvin_edge_p1_x.dat"
         "c.honeybee.autotvin_edge_p1_y.dat"
         "c.honeybee.autotvin_edge_p1_z.dat"
         "c.honeybee.autotvin_edge_p2_x.dat"
         "c.honeybee.autotvin_edge_p2_y.dat"
         "c.honeybee.autotvin_edge_p2_z.dat"
         "c.honeybee.autotvout_ap_return.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.honeybee.autotvout_ap_return.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
