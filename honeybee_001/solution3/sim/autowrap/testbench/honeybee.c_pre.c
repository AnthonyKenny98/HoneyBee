# 1 "/mnt/hgfs/Thesis/HoneyBee/src/honeybee.c"
# 1 "/mnt/hgfs/Thesis/HoneyBee/src/honeybee.c" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 149 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/mnt/hgfs/Thesis/HoneyBee/src/honeybee.c" 2
...
_Bool lineIntersectPrism(point_t obs, edge_t edge) {
    ...
    float max = minFloat3(
        ...
        lessThan(edge.p1.y, edge.p2.y, obs.y, 1),
        lessThan(edge.p1.z, edge.p2.z, obs.z, 1)
    );
    float min = maxFloat3(
