...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "honeybee.autotvin.dat"
	set constFileTvOut       "honeybee.autotvout.dat"
	set constFileHdlTvIn     "honeybee.autohdltvin.dat"
	set constFileHdlTvOut    "honeybee.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
